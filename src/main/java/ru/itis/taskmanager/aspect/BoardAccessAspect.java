package ru.itis.taskmanager.aspect;
...
public class BoardAccessAspect {
    ...
    @Autowired
    public BoardAccessAspect(BoardMemberService boardMemberService) {
        this.boardMemberService = boardMemberService;
    }

    @Around(value = "@annotation(ru.itis.taskmanager.aspect.BoardAccess)) && args(UserDetailsImpl, Long,..)")
